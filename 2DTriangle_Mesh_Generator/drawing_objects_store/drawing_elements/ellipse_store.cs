...
namespace _2DTriangle_Mesh_Generator.drawing_objects_store.drawing_elements
{
    public class ellipse_store
    {
        ...
        private int segment_count = 16;

        public ellipse_store(int t_ellipse_id, double td_x, double td_y, double d_scale, double tran_tx, double tran_ty, Color pt_clr)
        {
            // Main constructor
            this.ellipse_id = t_ellipse_id;
            this.d_x = (td_x - tran_tx) * d_scale;
            this.d_y = (td_y - tran_ty) * d_scale;
            this.ellipse_clr = pt_clr;
            this.ellipse_raidus = 0.008;
        ...
        private void set_ellipse_segments()
        {
            ...
            ellipse_segments.update_scale(1.0, 0.0, 0.0);
        }
